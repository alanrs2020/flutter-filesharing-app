...
<head>
  ...
  <button id="loadMore">Load More</button>
          ...
          for(var i=0;i<sizeOfLength;i++){
            ...
            var name = documentList[i];
            //var name = "storage/document.pdf";
...
var loadMore = document.getElementById('loadMore');
  ...
  loadMore.addEventListener('click',event=>{
    if (num+10 <=documentList.length) {
      startNum = startNum +10;
      loadData(num +10);
      console.log(num);
    }else{
    startNum = documentList.length - startNum;
      loadMore(documentList.length);
